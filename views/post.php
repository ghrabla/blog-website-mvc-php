...
<body>
    ...
    <div class="card-body bg-light">
        <a href="<?php echo BASE_URL; ?>post" title="Déconnexion" class="btn btn-link mr-2 mb-2">
        ...
        <form method="post" class="float-right mb-2 d-flex flex-row">
            ...
            <button class="btn btn-danger btn-sm" name="find" type="submit"><i class="fas fa-search"></i></button>
        </form>
            ...
            <div>
                ...
                <form method="post">
                    ...
                    <div class="add-comment">
                        ...
                        <button type="button" class="see_all">see all comment</button>
                        <!-- The Modal -->
                        <div  class="modal-popup">
                            <!-- Modal content -->
                            <div class="modal-content">
                                <span class="close-span">&times;</span>
                                <div class="comment-all-content">
                                    <p>comments</p>
                                    <?php
